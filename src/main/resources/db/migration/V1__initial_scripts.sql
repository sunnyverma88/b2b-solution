...
insert into app_role (name, created_at, updated_at) values ('USER' , current_timestamp,  current_timestamp);
insert into app_role (name, created_at, updated_at) values ('ADMIN' , current_timestamp,  current_timestamp);
insert into app_role (name, created_at, updated_at) values ('SUPER_ADMIN' , current_timestamp,  current_timestamp);
insert into app_role (name, created_at, updated_at) values ('FINANCE_APPROVER' , current_timestamp,  current_timestamp);
