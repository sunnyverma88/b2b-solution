...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/product/edit").hasAuthority(PRIV_ADMIN_CAP)
                ...
                .antMatchers("/order/history/admin").hasAuthority(PRIV_ADMIN_CAP)
                .antMatchers("/order/edit/*").hasAuthority(PRIV_ADMIN_CAP)
